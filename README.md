...
补充：突然想到的一个不恰当的例子，关于我所使用的手机，设置了指纹解锁，以及输入密码。如果3天时间内，没有输入过密码，即一直使用指纹解锁的话，那么72小时之后，锁屏之后再看手机信息的话，那么将会提示了「请输入密码」，如果3天时间内如果有某个时刻使用了密码解锁的话，那么就会基于这个时刻，重新计时，即重新再来3天。总之就是在减少请求次数，即在规定的时间周期之内，如果你发请求了，那会导致重新计时了，唯有时间周期过后，你才能真正地发请求！当然这存在，你一直发布了请求情况！除非你稍微停顿了一下……
